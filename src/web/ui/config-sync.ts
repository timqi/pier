...
export function configSyncPane(): { el: HTMLElement; dispose(): void } {
  ...
  function render(): void {
    ...
    sharing.append(h("p", "text-[12px] text-neutral-500", "Anyone with the link can read shared prompts and model definitions. API keys, headers and endpoints stay private."));
