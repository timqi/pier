...
- Every new run carries \`--name "<a few words>"\` that hit its intent — the session's title in the user's language, no role word (the In progress drawer tags a lead design or build itself).
